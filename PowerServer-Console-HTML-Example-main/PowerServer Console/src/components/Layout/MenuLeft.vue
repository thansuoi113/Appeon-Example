<template>
  <div class="menu-left" v-if="showMenuMobile">
    <div class="header" :style="{background: theme.menuLeftBc}" @click="goPage('/dashboard/console')">
      <img :src="require('@/assets/icons/icons/serverSvg.svg')" style="heigth:25px;width:25px;margin-left:20px;margin-top:10px"></image>
      <p :style="{color: theme.textColor, width: collapse ? '0' : '200px' }">{{systemName}}</p>
    </div>
